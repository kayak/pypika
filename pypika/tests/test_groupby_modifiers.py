...
class RollupTests(unittest.TestCase):
    ...
    def test_mysql_rollup_two_groupbys(self):
        ...
        self.assertEqual('SELECT "foo","fiz",SUM("bar") FROM "abc" GROUP BY "foo","fiz" WITH ROLLUP', str(q))
    ...
    def test_verticaoracle_func_partial(self):
        ...
        self.assertEqual('SELECT "foo","fiz","buz",SUM("bar") FROM "abc" GROUP BY ROLLUP("foo","fiz"),"buz"', str(q))
    ...
    def test_verticaoracle_from_parameters(self):
        ...
        self.assertEqual('SELECT "foo","fiz",SUM("bar") FROM "abc" GROUP BY "foo",ROLLUP("fiz")', str(q))
